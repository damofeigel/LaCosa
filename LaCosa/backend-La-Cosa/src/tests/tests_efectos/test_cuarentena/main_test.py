...
from partidas.events import EventoResultadoDefensa
from partidas.utils import (armador_evento_turno, lista_partidas, armador_evento_mano, armar_broadcast, 
                            armador_ronda, armador_evento_carta,)
...
lista_jugadores = [Jugador(id=0, nombre="Ironclad", posicion=0, rol="Humano", mano=[]), 
                   Jugador(id=1, nombre="Silent", posicion=1, rol="Humano", mano=[], cuarentena=False),
                   Jugador(id=2, nombre="Defect", posicion=2, rol="Infectado", mano=[]),
                   Jugador(id=3, nombre="Neow", posicion=2, rol="Infectado", mano=[], cuarentena=True, rondas_en_cuarentena=2)]
...
lista_jugadores[0].agregar_carta_mano(CardSchema(id=84, 
                                                 num_players=4, 
                                                 type="Panico", 
                                                 name="Cuarentena", 
                                                 effect="cuarentena :p", 
...
async def fin_turno(id_partida: int):
    ...
    armar_broadcast(partida_ejemplo, evento_ronda, "Ronda")
