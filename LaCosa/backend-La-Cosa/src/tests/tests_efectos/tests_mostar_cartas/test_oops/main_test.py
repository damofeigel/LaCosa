...
lista_jugadores[0].agregar_carta_mano(CardSchema(id=105, 
                                                 num_players=4, 
                                                 type="Panico", 
                                                 name="Oops", 
                                                 effect="Muestra todas tus cartas a todos los jugadores. Solo puedes jugar"\
                                                            " esta carta sobre ti mismo", 
                                                 target="self"))
