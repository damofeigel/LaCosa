...
lista_jugadores[0].agregar_carta_mano(CardSchema(id=106, 
                                                 num_players=4, 
                                                 type="Panico", 
                                                 name="Solo entre nosotros", 
                                                 effect="Mira la mano de cartas de un jugador adyacente", 
                                                 target="neighbour"))
                                    
lista_jugadores[0].agregar_carta_mano(CardSchema(id=10101,
                                                num_players=4, 
                                                type="Epica", 
                                                name="Solo entre nosotros", 
                                                effect="Ganas automagicamente la partida :o", 
                                                target="neighbour"
                                        ))
